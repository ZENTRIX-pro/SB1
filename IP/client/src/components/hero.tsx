...
export function Hero() {
  ...
  if (isLoading || heroSlides.length === 0) {
    return (
      <section className="h-[55vh] min-h-[55vh] md:h-[95vh] md:min-h-[95vh] bg-neutral-100 animate-pulse" />
    );
  }

  return (
    <>
      <section className="md:hidden h-[55vh] min-h-[55vh] pt-14 bg-black overflow-hidden">
      ...
      <section className="hidden md:block h-[95vh] min-h-[95vh] pt-16 bg-white overflow-hidden">
